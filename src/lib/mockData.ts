...
export const DEFAULT_MOCK_ANALYSIS: AnalysisResult = {
  ...
  disclaimer:
    "This resume analysis is generated by AI for guidance purposes only. Hiring requirements and evaluation criteria may vary across organizations.",
};
...
export function generateMockAnalysis(
  ...
  const candidateKeywords = [
    ...
    {
      name: "Tailwind CSS",
      test: jdLower.includes("tailwind") || jdLower.includes("css"),
    },
    {
      name: "REST APIs",
      test: jdLower.includes("api") || jdLower.includes("rest"),
    },
    { name: "Git & Version Control", test: jdLower.includes("git") },
    {
      name: "State Management",
      test: jdLower.includes("state") || jdLower.includes("redux"),
    },
    {
      name: "Responsive Design",
      test: jdLower.includes("responsive") || jdLower.includes("mobile"),
    },
  ];
  ...
  const rawData = {
    score: Math.floor(75 + Math.random() * 15), // Realistic score between 75 and 89
